          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative max-w-md w-full">
                {/* Fallback to online collage concept image */}
                <img
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed font-medium">
                Relux Gold Memberships gives you a comfortable stay in a decent 3* properties
                across India, and a perfect Sedan for your comfortable travel with a 24Hrs Online
                ...
                <table className="w-full border-collapse text-left text-sm font-semibold text-white">
                  <tbody>
                    ...
                    <tr className="bg-[#e67e22] border-b border-white/10">
                      ...
                      <td className="p-4 border-l border-white/10">Rs.4,00,000</td>
                    </tr>
                    ...
                    <tr className="bg-[#e67e22] border-b border-white/10">
                      ...
                      <td className="p-4 border-l border-white/10">5000/Year</td>
                    ...
                    <tr className="bg-[#d35400] border-b border-white/10">
                      ...
                      <td className="p-4 border-l border-white/10">3,50,000</td>
                    </tr>
                    ...
                    <tr className="bg-[#784212] border-b border-white/10">
                      ...
                      <td className="p-4 border-l border-white/10 line-through text-slate-300">9,00,000</td>
                    </tr>
                    ...
                    <tr className="bg-[#27ae60] text-lg font-black">
                      ...
                      <td className="p-4 border-l border-white/15">4,00,000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {submitted ? (
              <div className="text-center py-6 space-y-4">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Thank you for joining Relux Gold. Our VIP relationship officer will contact you within 2 hours to confirm your membership card delivery.
                </p>
              </div>
            ) : (
              <form onSubmit={handleJoinSubmit} className="space-y-4">
                <h3 className="text-xl font-bold text-slate-950 font-serif">Apply for Gold Membership</h3>
                <p className="text-xs text-slate-600">
                  Fill in your details below to activate your premium 10-year Gold holiday card immediately.
                </p>
